# Generated by Django 2.2.2 on 2020-01-08 00:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, help_text='ktation code', max_length=4, null=True)),
                ...
                ('begt', models.DateField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Station',
            fields=[
                ...
                ('description', models.CharField(default=None, help_text='Station description', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endt', models.DateTimeField(blank=True, null=True)),
                ('flag', models.CharField(blank=True, choices=[('C', 'continuous'), ('T', 'triggered'), ('G', 'geophysical'), ('W', 'weather')], max_length=10, null=True)),
                ...
                ('begt', models.DateTimeField(blank=True, null=True)),
